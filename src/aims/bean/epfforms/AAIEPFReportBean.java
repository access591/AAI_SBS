...
public class AAIEPFReportBean implements Serializable{
	...
	String settlementReason="",pensionContribution="",netAmt="",transDate="",remarks="",requestedBy="",adjPensioncontri="";
	ArrayList advancesList,lonesList,finalSettlementList,reportList1,reportList2,reportList3,voucherInfoList;
	ArrayList advancesList2,lonesList2,finalSettlementList2;
	String keyNo="",debit="",credit="",voucherNo="";
	public String getAdjPensioncontri() {
		return adjPensioncontri;
	}
	public void setAdjPensioncontri(String adjPensioncontri) {
		this.adjPensioncontri = adjPensioncontri;
	}
	public ArrayList getReportList3() {
		return reportList3;
	}
	public void setReportList3(ArrayList reportList3) {
	...
	public ArrayList getVoucherInfoList() {
		return voucherInfoList;
	}
	public void setVoucherInfoList(ArrayList voucherInfoList) {
