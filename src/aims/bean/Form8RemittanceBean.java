...
public class Form8RemittanceBean {
	...
	double   aprMnthArrearContri=0.0,mayMnthArrearContri=0.00,junMnthArrearContri=0.0,julMnthArrearContri=0.0,augMnthArrearContri=0.0,sepMnthArrearContri=0.0,octMnthArrearContri=0.0, novMnthArrearContri=0.0,decMnthArrearContri=0.0,janMnthArrearContri=0.0,febMnthArrearContri=0.0,marMnthArrearContri=0.0;
 
	 
	public double getAprMnthArrearContri() {
		return aprMnthArrearContri;
	}
	public void setAprMnthArrearContri(double aprMnthArrearContri) {
		this.aprMnthArrearContri = aprMnthArrearContri;
	}
	public double getAugMnthArrearContri() {
		return augMnthArrearContri;
	}
	public void setAugMnthArrearContri(double augMnthArrearContri) {
		this.augMnthArrearContri = augMnthArrearContri;
	}
	public double getDecMnthArrearContri() {
		return decMnthArrearContri;
	}
	public void setDecMnthArrearContri(double decMnthArrearContri) {
		this.decMnthArrearContri = decMnthArrearContri;
	}
	public double getFebMnthArrearContri() {
		return febMnthArrearContri;
	}
	public void setFebMnthArrearContri(double febMnthArrearContri) {
		this.febMnthArrearContri = febMnthArrearContri;
	}
	public double getJanMnthArrearContri() {
		return janMnthArrearContri;
	}
	public void setJanMnthArrearContri(double janMnthArrearContri) {
		this.janMnthArrearContri = janMnthArrearContri;
	}
	public double getJulMnthArrearContri() {
		return julMnthArrearContri;
	}
	public void setJulMnthArrearContri(double julMnthArrearContri) {
		this.julMnthArrearContri = julMnthArrearContri;
	}
	public double getJunMnthArrearContri() {
		return junMnthArrearContri;
	}
	public void setJunMnthArrearContri(double junMnthArrearContri) {
		this.junMnthArrearContri = junMnthArrearContri;
	}
	public double getMarMnthArrearContri() {
		return marMnthArrearContri;
	}
	public void setMarMnthArrearContri(double marMnthArrearContri) {
		this.marMnthArrearContri = marMnthArrearContri;
	}
	public double getMayMnthArrearContri() {
		return mayMnthArrearContri;
	}
	public void setMayMnthArrearContri(double mayMnthArrearContri) {
		this.mayMnthArrearContri = mayMnthArrearContri;
	}
	public double getNovMnthArrearContri() {
		return novMnthArrearContri;
	}
	public void setNovMnthArrearContri(double novMnthArrearContri) {
		this.novMnthArrearContri = novMnthArrearContri;
	}
	public double getOctMnthArrearContri() {
		return octMnthArrearContri;
	}
	public void setOctMnthArrearContri(double octMnthArrearContri) {
		this.octMnthArrearContri = octMnthArrearContri;
	}
	public double getSepMnthArrearContri() {
		return sepMnthArrearContri;
	}
	public void setSepMnthArrearContri(double sepMnthArrearContri) {
		this.sepMnthArrearContri = sepMnthArrearContri;
	}
