...
public class FinacialDataBean implements Serializable {
	private String cpfAccNo="",employeeOldNo="",employeeNewNo="",employeeName="",designation="",pensionOption="";
	private String emoluments="",empPfStatuary="",empVpf="",principal="", interest="",empTotal="",aaiPf="",aaiPension="",aaiTotal="";
	private String airportCode="",monthYear="",dateofBirth="",pensionNumber="";
	private String basic="",specialBasic="",dailyAllowance="",toDate="",fromDate="",gpf="",remarks="";
	private String missingFlag="",pfAdvance="",advanceDrawn="",partFinal="",cpfInterest="",missingPF="",region="",icon="",contextPath="";
	private String cpfArriers="",dateofJoining="",cpfDifference="",previousMonth="",penContri="",dueemoluments="",duepensionamount="",arrearBrkUpFlag="";
