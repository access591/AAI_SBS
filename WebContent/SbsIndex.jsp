...
function clock() {
	...
	<body onLoad="document.forms[0].username.focus();" >
		...
		<div class="row">
		<div class="col-md-9">1.	SBS card 21-22 has released , same may be checked .</br>

2.	OB Adjustments FY- 2021-22 </br>
         *  OB Adjustments inclusive of interest for prior year will be uploaded .</br>
    
         *  Upload will be done only a receipt of Justification work sheet citing details from  nodal officer 
		</div>
			<!--<div class="col-md-9">
...
<div class="col-md-2"></div>
	...
	<div class="details">
								...
								<form  name="login" class="login-form"  method="post">
									...
									%>
									<img src="<%=basePath%>Content/Images/pension-img.png" alt="" width="240px">
									<p
