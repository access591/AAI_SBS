...
<%
	...
	labelAry = new String[]{"Sl.No","Account No","Name of employee (in block capitals)","Father's name or Husband's Name (in case of married Woman)","Age at Entry(Years)","Date of birth","Sex","Date of entitlement for membership","UAN NO","Remarks Previous Account No. and particulars of previous service, if any"};
		...
		<table width=100% border=1 bordercolor="gray" cellpadding=2 cellspacing=0>
			...
			%>
				<tr>
					...
					<td class="Data" width="5%"><%=formsetBean.getUanno()%></td>
