...
<%
	...
	title = "RETURN OF EMPLOYEES ENTITLED FOR MEMBERSHIP OF THE EMPLOYEES";
	...
	labelAry = new String[]{"Sl.No","Account No","Name of employee (in block capitals)","Designation","Father's name or Husband's Name (in case of married Woman)","Date of birth","Sex","Option","Date of entitlement for membership(Date of Joining)","Station","Region","Remarks Previous Account No. and particulars of previous service, if any"};
...
<tr>
	<td  colspan=2 class="label" align=center>PENSION FUND DURING THE MONTH OF <u><font color=blue><%=request.getAttribute("selectedDate")%></font></u></td>
</tr>
<tr>
	...
	<td  colspan=2> 
		<table width=100% border=1 bordercolor="gray" cellpadding=2 cellspacing=0>
			...
			%>
				...
				<td class="Data" width="5%"><%=formsetBean.getDesignation()%></td>
					...
					<td class="Data" width="5%"><%=formsetBean.getAirportCode()%></td>
					<td class="Data" width="5%"><%=formsetBean.getRegion()%></td>
...
<tr>
	<td class="tb">Stamp of the Establishment</td>
