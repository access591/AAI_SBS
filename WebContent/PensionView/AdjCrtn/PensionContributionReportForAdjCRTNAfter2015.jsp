...
function editEmoluments(monthyear,cpfaccno,region,airportcode,pensionNo,emolumentxtextboxno,addcontextboxno,epftextboxno,vpftextboxno,principletextboxno,interesttextboxno,advancetextboxno,pfwsubtextboxno,aaipfboxno,pfwcontriboxno,contributionboxno,emolumentsmntsboxno,pensionoption,editid,adjOBYear,dob,pfcardnarrationboxno){ 
	...
	if(((prevemoluments==emoluments) &&(prevepf=epf)&&(prevvpf=vpf)&&(prevaddcon=addcon)
	 ...
	 //alert(epf);
		...
		var url="<%=basePath%>reportservlet?method=editTransactionDataForAdjCrtn&pensionNo="+pensionNo+"&cpfaccno="+cpfaccno+"&emoluments="+emoluments+"&addcon="+addcon+"&monthyear="+monthyear+"&region="+region+"&airportcode="+airportcode+"&editid="+editid+"&epf="+epf+"&vpf="+vpf+"&principle="+principle+"&interest="+interest+"&contri="+contri+"&pensionoption="+pensionoption+"&noofmonths="+noofmonths+"&adjOBYear="+adjOBYear+"&editTransFlag="+editTransFlag+"&dateOfBirth="+dob+"&from7narration="+pfcardnarration;
  // alert(url);
	 xmlHttp.open("post", url, true);
  ...
  noofMonths="1";
   ...
   remainAaiInt_Saved_Value= remainAaiInt;
   	...
   	adjCrtnService.saveprvadjcrtntotals(personalInfo.getPensionNo(),dispYear,form2Status,
							 ...
							 Double.parseDouble(finalAaiNetOB.toString()),  0, Double.parseDouble(finalAaiNetOBIntrst.toString()), pensionInterest,remaininInt_Saved_Value ,remainAaiInt_Saved_Value);
   ...
   ArrayList prevGrandTotalsList = new ArrayList();
				...
				// +"aaiContri_Intrst_2012_2013"+aaiContri_Intrst_2012_2013+"aaiContri_Intrst_2013_2014"+aaiContri_Intrst_2013_2014+"aaiContri_Intrst_2014_2015"+aaiContri_Intrst_2014_2015+"aaiContri_Intrst_2015_2016"+aaiContri_Intrst_2015_2016);
				...
				pc_Intrst_2015_2016 =   Math.round(( pc_Intrst_2010_2011+pc_Intrst_2011_2012+pc_Intrst_2012_2013+pc_Intrst_2013_2014+pc_Intrst_2014_2015+ PenscontriTot_diff )* 9.15/100) ;					
				...
				aaiContri_Intrst_2016_2017 =  Math.round((aaiContri_Intrst_2015_2016+AAiContriTot_diff )* 9.15/100) ;
				...
				aaiContri_Intrst_2016_2017 =  Math.round((AAiContriTot_diff )* 9.15/100) ;
