  ...
  <tr>
    <td colspan="12"><table width="90%" align="center"  border="1" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="8%" colspan="11" class="label" align="center">Received from other organisation</td>
      ...
      <tr>
        ...
        <td  class="label" align="center">Pension Contribution  (ECR) @8.33% of col.10</td>
        <td  class="label" align="center">Interest on PC  (ECR)</td>
        <td  class="label" align="center">Total Amt(PC+Interest )<br>19B (19+19A)</td>    
      </tr>
      <tr>
        ...
        <td class="Data" align="center">19(A)</td>
        <td class="Data" align="center">19(B)</td>
        ...
        <%
		double grandpc=0.00,grandintrest=0.00,grandaddcontri=0.0,grandaddcontripc=0.0,totalpc=0.0,totalinterstpc=0.0,pcemoluments=0.0;
		...
		String shownYear="",leavedata="";
  		...
  		totalpc=Double.parseDouble(pensionCardInfo.getTotaldiffpc());
  		totalinterstpc=Double.parseDouble(pensionCardInfo.getTotalintrestpc());
  		pcemoluments=Math.round(Double.parseDouble(pensionCardInfo.getPcemoluments()));
  		...
  		grandaddcontri=Double.parseDouble(pensionCardInfo.getAddcontri());
  		grandaddcontripc=Double.parseDouble(pensionCardInfo.getAddcontripc());
  	%>
...
<%}}}%>
   <tr>
    ...
    <td align="center" class="Data" nowrap><%=personalInfo.getDateofbirth()%></td>
    <td align="center" class="Data" nowrap><%=personalInfo.getRem_month()%></td>
    <td align="center" class="Data">&nbsp;</td>
	<td align="center" class="Data" nowrap><%=pcemoluments%></td>
	<td align="center" class="Data" nowrap>-<%=grandaddcontri%></td>
	<td align="center" class="Data" nowrap><%=grandaddcontripc%></td>
	<td align="center" class="Data">&nbsp;</td>
	<td align="center" class="Data">&nbsp;</td>
	<td align="center" class="Data">&nbsp;</td>
	<td align="center" class="Data">&nbsp;</td>
	<td align="center" class="Data" nowrap>-<%=(totalpc+totalinterstpc)%></td>
	<td align="center" class="Data">&nbsp;</td>
	<td align="center" class="Data"><%=totalpc %></td>
	<td align="center" class="Data"><%=totalinterstpc %></td>
	<td align="center" class="Data" nowrap><%=(totalpc+totalinterstpc)%></td>
