  ...
  <head>
	...
	function testSS(){ 
		...
		var sheight=screen.Height-150;
     	url="<%=basePath%>reportservlet?method=crtnMadeInPCReport&fromDate="+fromDate+"&toDate="+toDate+"&reportType="+reportType;
	 ...
	 function resetVals(){
		document.forms[0].action="<%=basePath%>reportservlet?method=getImpacCalcLogReport&accessCode=PE040203&frmName=ImpacCalcLogReport";
  ...
  function disableEnterKey(e)
{
  ...
  <body class="BodyBackground"  onload="javascript:loadDet();" onkeypress="return disableKeyPress(event)">
		<form name="ImpacCalcLogReport" action="" >
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<table width="70%" border="0" align="center" cellpadding="1" cellspacing="0" class="tbborder">
							...
							<td height="5%" colspan="4" align="center" class="ScreenMasterHeading">
						 	Impact Calculator Log Report Input Params
							</td>
