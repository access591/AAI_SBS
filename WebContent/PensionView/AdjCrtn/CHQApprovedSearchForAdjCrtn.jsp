...
<html>
 ...
 function  getForm2Report(repName,pensionno,adjobyear){ 
 	var url=""; 
 url = "<%=basePath%>reportservlet?method=uploadToForm2&frmName=CHQApproved&pensionno="+pensionno+"&adjobyear="+adjobyear; 
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<table width="85%" border="0" align="center" cellpadding="1" cellspacing="0" class="tbborder">
							...
							<td height="5%" colspan="4" align="center" class="ScreenMasterHeading">
						 	Calculate AdjOB On Monthly CPF Corrections[CHQ Approved Search]
							</td>
				...
				<table width="85%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbborder"><!--
				 			...
				 			--><tr>							
								...
								<display:table  style="width: 930px" id="advanceList" sort="list"   pagesize="15" name="requestScope.searchList" requestURI="./reportservlet?method=loadPCReportForAdjDetails" >   											
								  ...
								  <%}%>
								    <display:column title="Form2" media="html">
									<a href="#" onclick="getForm2Report('loadForm2','<%=((EmpMasterBean)pageContext.getAttribute("advanceList")).getPfid()%>','<%=((EmpMasterBean)pageContext.getAttribute("advanceList")).getReportYear()%>')"><img src="./PensionView/images/form2.gif" border="0"  /></a>									
									</display:column>
								    </display:table>
								</td>
							</tr> 
