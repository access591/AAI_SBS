...
<html>
    ...
    function testSS(){ 
    	...
    	pensionno=    document.forms[0].empsrlNo.value;    	 
     	...
     	url="<%=basePath%>pcreportservlet?method=searchAdjRecordsforPc&accessCode="+accessCode+"&reportYear="+adjobyear+"&status="+status+"&searchFlag=S&frmName=adjcorrections";
   ...
   if(answer){
   var flag="true";
   url="<%=basePath%>pcreportservlet?method=getDeleteAllRecordsforPc&accessCode="+accessCode+"&empserialno="+employeeNo+ "&reportYear="+reportYear+"&frmName=adjcorrections";
 ...
 //  }
  ...
  // if(approvemonth=="15"){
   //alert("Please Select the Approved Month");
  // document.getElementsByName(pfid_statusboxno)[0].value="NO-SELECT";
//   return false;
  // }
    if(status!="NO-SELECT"){ 
   ...
   return false;
	...
	var url = "<%=basePath%>pcreportservlet?method=updateAdjCrtnStatusforPc&pensionno="+employeeNo+"&stageStatus="+stageStatus+"&processedStage="+processedStage+"&accessCode="+'<%=accessCode%>'+"&reportYear="+reportYear+"&jvno="+jvnostatus+"&frmName=adjcorrections";  
  	//alert(url);
  		document.forms[0].action=url;
		document.forms[0].method="post";
		document.forms[0].submit();
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<table width="85%" border="0" align="center" cellpadding="1" cellspacing="0" class="tbborder">
							...
							<td height="5%" colspan="4" align="center" class="ScreenMasterHeading">
						 	Impact Calculate For PC[Approve Search]
							</td>
