  ...
  <% System.out.println("===========totalEmpNet"+totalEmpNet+"totalAAINet"+pensionAdjOB);%>
     ...
     if(!adjOutstandadv.equals("0")&& Integer.parseInt(adjOutstandadv.toString())!=0 && (dispYear.equals("2009-10")|| dispYear.equals("2010-11") || dispYear.equals("2011-12")|| dispYear.equals("2012-13")|| dispYear.equals("2013-14") || dispYear.equals("2014-15")|| dispYear.equals("2015-16")|| dispYear.equals("2016-17")|| dispYear.equals("2017-18") || dispYear.equals("2018-19") )){%>
       ...
       <% } else{ %>
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <%if(!empSubOB.equals("0")&& Integer.parseInt(empSubOB.toString())!=0 && (dispYear.equals("2009-10")|| dispYear.equals("2010-11") || dispYear.equals("2011-12")|| dispYear.equals("2012-13")|| dispYear.equals("2013-14")|| dispYear.equals("2014-15")|| dispYear.equals("2015-16") || dispYear.equals("2016-17")|| dispYear.equals("2017-18")|| dispYear.equals("2018-19"))){%>
...
<%} %>
	 ...
	 <%
	 	...
	 	if(pensionCardInfo.getCbFlag().equals("Y")){
	 		...
	 		String toyear=""+(Integer.parseInt(dispYear.substring(0,4))+1);
	 				...
	 				if(advancePFWPaid>0 && (dispYear.equals("2013-14")|| dispYear.equals("2014-15")|| dispYear.equals("2015-16")|| dispYear.equals("2016-17")|| dispYear.equals("2017-18"))){
	 				advint= new Double(df.format((advancePFWPaid * rateOfInterest)/100/12)).doubleValue();
	 				//System.out.println("advint======="+advint);
	 				}
	 				if(totalPFDrwn>0 && (dispYear.equals("2013-14")|| dispYear.equals("2014-15")|| dispYear.equals("2015-16")|| dispYear.equals("2016-17")|| dispYear.equals("2017-18"))){
				  ...
				  //   System.out.println("arrearEmpNetInterest"+arrearEmpNetInterest+"arrearAaiNetInterest"+arrearAaiNetInterest+"noOfmonthsForInterest"+noOfmonthsForInterest);
				    ...
				    System.out.println("--prasanthiiiiiii--personalInfo.isNoInterest()------"+personalInfo.isNoInterest()+personalInfo.isObInterst()+"personalInfo.isAdjObInterst()"+personalInfo.isAdjObInterst());
				    System.out.println("--Kavyaaaaa--"+rateOfInterest+obList+Math.round(dispTotalAAINet)+Math.round(aaiNetInterest)+Math.round(dispTotalEmpNet)+Math.round(empNetInterest)+Math.round(totalPensionContr)+Math.round(pensionInterest)+totalAdvances+principle+noOfmonthsForInterest+personalInfo.isObInterst()+personalInfo.isAdjObInterst());
 ...
 <%
	...
	if(dispYear.equals("2013-14")||dispYear.equals("2014-15")||dispYear.equals("2015-16") ||dispYear.equals("2016-17")||dispYear.equals("2017-18") ){
	...
	if((isFrozedSeperation==true && personalInfo.getChksepmnths()<=0)&& (dispYear.equals("2013-14")||dispYear.equals("2014-15")||dispYear.equals("2015-16")||dispYear.equals("2016-17")||dispYear.equals("2017-18"))){
