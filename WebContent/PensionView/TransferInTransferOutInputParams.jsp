<%String path = request.getContextPath();
            String basePath = request.getScheme() + "://"
                    ...
                    String[] year = {"2007-08","2008-09","2009-10","2010-11","2011-12","2012-13","2013-14","2014-15","2015-16"};
                    String[] userYears = {"2007-08","2008-09","2009-10","2010-11","2011-12","2012-13","2013-14","2014-15","2015-16"};	
            %>
...
<style>
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>reportservlet?method=loadTransferINOUT";
   ...
   var bulkPrintFlag='false';
	function bulkreport(userID){
		...
		if(bulkpfidlist=='[Select One]'){
				alert('Please Select PFID Printing List');
	...
	function validateForm() {
		...
		if(airportcode=='NO-SELECT'){
			alert('Please Select the Aiport Name');
		...
		url="<%=basePath%>reportservlet?method=TransferInOutReport"+params;
			...
			<table width="65%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbborder">
				<tr>
					<td height="5%" colspan="2" align="center" class="ScreenMasterHeading">
						 Station Wise Employees In/Out Params
					</td>
				</tr>
				<tr>
					<td>
