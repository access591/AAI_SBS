...
<html>
	...
	function GetPCReport(){ 
	 		  var count=0;
		      var str=new Array();
		      var pensionno,cpfaccno,batchid,batchTime,updateDate;
...
<td>&nbsp;</td>
    ...
    <td colspan="6" class="reportlabel" style="text-decoration: underline" align="center">Edit Emoluments Log  </td>
			...
			String dateCompare ="",batchCompare ="",pensionNumber="",cpfAccNo = "",OLDEMOLUMENTS= "",NEWEMOLUMENTS="",OLDEMPPFSTATUARY="",NEWEMPPFSTATUARY="",MONTHYEAR="",UPDATEDDATE="";
			...
			<tr>
               ...
               //   System.out.println("----batchCompare------"+batchCompare+"====batchId="+batchId);
                   ...
                   <tr>
                   <td colspan="9" align="center"><%=UPDATEDDATE%></td>
                   </tr>
                   <%}%>
                   <%if(!batchCompare.equals(batchId)){
                    ...
                    %>
                   <tr>
                   <td colspan="9" align="left"><font size="2"><b>Updated Time </b> </font> <font size="2"><%=batchTime%></font> <input type="radio" name="chk"  value ="<%=pensionNumber%>*<%=cpfAccNo%>*<%=batchId%>*<%=UPDATEDDATE%>*<%=batchTime%>"/>
