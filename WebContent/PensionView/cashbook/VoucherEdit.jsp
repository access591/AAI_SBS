		...
		<script type="text/javascript">
			...
			function checkVoucher(){
				...
				for(var i=0;i<len;i++){
					...
					crebit += parseFloat(detailsRec[i][6]);
			...
			function showValues(index){  
				...
				for(var i=0;i<detailsRec.length;i++){  
					...
					if(i==index)	{ 
						...
						str+='<TD align=center >';
						str+='<input type=text name=cheque1 value=\''+detailsRec[i][4]+'\' style=width:70px maxlength=20></TD>';
						str+='<TD align=center >';
				...
				if(index!=-1){
					...
					document.forms[0].dmonth1.value=detailsRec[index][2].substring(0,3).toUpperCase();
					document.forms[0].dyear1.value=detailsRec[index][2].substring(4,8).toUpperCase();
				}
			}
...
%>
	...
	<body class="BodyBackground1" onload="loadValues();yearSelect();document.forms[0].searchImage.focus();suggestions.style.display='none';showParty(); ">
						...
						<table width="75%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbborder">
							<tr>
								<td height="5%" colspan="2" align="center" class="ScreenMasterHeading">
									...
									<%="C".equals(voucherInfo.getVoucherType())?"Contra  ":"P".equals(voucherInfo.getVoucherType())?"Payment  ":"Receipt  "%>Voucher[Add] &nbsp;&nbsp;
								</td>
								...
								<td height="15%">
									<table align="center" border="0" width="70%" cellspacing="5">
										<tr>
											...
											<td align="left">
												<input type="text" name="bankName" size="13" maxlength="50" onkeyup="getBankDetails('B')"  value="<%=voucherInfo.getBankName()%>"/>
											...
											<td align="left">
												<input type="text" name="accountNo" size="13" maxlength="50" readonly="readonly" value="<%=voucherInfo.getAccountNo()%>"/>
										...
										<tr>
											...
											<td align="left">
												<select name='trusttype' style='width:80px'>
													...
													<option value='I' <%="IAAI ECPF".equals(voucherInfo.getTrustType())?"Selected":"" %>>
														IAAI ECPF
													</option>
													<option value='N' <%="NAA ECPF".equals(voucherInfo.getTrustType())?"Selected":"" %> >
														NAA ECPF
													</option>
													<option value='A' <%="AAI EPF".equals(voucherInfo.getTrustType())?"Selected":"" %>>
														AAI EPF
													</option>
												</select>
											</td>
									...
									<%if(!"C".equals(voucherInfo.getVoucherType())){%>
										<tr>
											<td class="label" align="right">
												Type of Party&nbsp;
											</td>
											...
											<td align="left">
												<select name='party' onchange="showParty();" style='width:80px'>
													...
													<option value='P' <%="P".equals(voucherInfo.getPartyType())?"Selected":"" %>>
														Party
													</option>
												</select>
											</td>
										...
										<tr id="divNomineeHead" style="display:none">
											...
											<td align="left">
												<input type="text" size="13" value='<%="E".equals(voucherInfo.getPartyType())?voucherInfo.getEmpPartyCode():""%>' name="epfid" maxlength="50"  width="150px" readonly="readonly" />
											...
											<td align="left">
												<input type="text" size="18" value='<%="E".equals(voucherInfo.getPartyType())?voucherInfo.getPartyDetails():""%>' name="eName" readonly="readonly" maxlength="50"  width="150px" />
											</td>
										...
										<tr id="divNominee2" style="display:none">
											...
											<td align="left">
												<input type="text" size="13" name="pName" maxlength="50" readonly="readonly" value='<%="P".equals(voucherInfo.getPartyType())?voucherInfo.getEmpPartyCode():""%>' />
