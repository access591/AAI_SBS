<%@ page language="java" import="aims.bean.cashbook.PartyInfo" buffer="16kb"%>
...
PartyInfo partyInfo = (PartyInfo) request
					.getAttribute("einfo");
BankMasterInfo info = partyInfo.getBankInfo();
%>
...
<html>
	...
	<body class="BodyBackground1" onload="document.forms[0].partyDetail.focus();">
								...
								<td height="15%">
									<table align="center" cellspacing="5">
										<tr>
											...
											<td align="left">
												<textarea name="partyDetail" cols="26" tabindex="1" rows="" cols="" rows=""><%=partyInfo.getPartyDetail().trim()%>
												</textarea>
											</td>
										</tr>
										<tr>
											...
											<td align="left">
												<input type="text" name="mobileNo" maxlength="25" tabindex="2" value="<%=partyInfo.getMobileNo()%>" />
											</td>
											<td width="10px">
											...
											<td align="left">
												<input type="text" name="faxNo" maxlength="25" tabindex="3" value="<%=partyInfo.getFaxNo()%>" />
											</td>
										</tr>
										<tr>
											<td class="label" align="right">
											...
											<td align="left">
												<input type="text" name="contactNo" maxlength="25" tabindex="3" value="<%=partyInfo.getContactNo()%>"/>
											</td>
											<td width="10px">
											...
											<td align="left">
												<input type="text" name="email" maxlength="25" tabindex="4" value="<%=partyInfo.getEmailId()%>" />
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td align="left">
												<input type="text" name="bankName" maxlength="25" tabindex="6"  value='<%=info.getBankName()%>'/>
											</td>
											<td width="10px">
											...
											<td align="left">
												<input type="text" name="branchName" maxlength="25" tabindex="7" value='<%=info.getBranchName()%>'/>
											</td>
										</tr>
										<tr></tr>
										<tr>
											...
											<td align="left">
												<input type="text" name="bankCode" maxlength="25" tabindex="8" value='<%=info.getBankCode()%>'/>
											</td>
											<td width="10px">
											...
											<td align="left">
												<textarea name="address" cols="26" tabindex="9" rows="" style='width=130px' ><%=info.getAddress().trim()%></textarea>
											</td>
										</tr>
										<tr>
											<td class="label" align="right">
											...
											<td align="left">
												<input type="text" name="phoneNo" maxlength="25" tabindex="10" value='<%=info.getPhoneNo()%>'/>
											</td>
											<td width="10px">
											...
											<td align="left">
												<input type="text" name="bFaxNo" maxlength="25" tabindex="11" value='<%=info.getFaxNo()%>'/>
											</td>
										</tr>
										<tr>
											<td class="label" align="right">
											...
											<td align="left">
												<input type="text" name="accountCode" maxlength="25" size="15" readonly="readonly" value='<%=info.getAccountCode()%>'/>
												&nbsp;
											...
											<td align="left">
												<input type="text" name="accountNo" maxlength="25" tabindex="13" value='<%=info.getAccountNo()%>'/>
											</td>
										</tr>
										<tr>
											<td class="label" align="right">
											...
											<td align="left">
												<select name="accountType" tabindex="14" style="Width:80px" >
													<option value="S" <%="S".equals(info.getAccountType())?"Selected":""%> >
														Savings
													</option>
													<option value='C' <%="C".equals(info.getAccountType())?"Selected":""%>>
														Current
													</option>
												</select>
											</td>
											...
											<td align="left">
												<input type="text" name="ifscCode" maxlength="10" tabindex="15" value='<%=info.getIFSCCode()%>'/>
											</td>
										</tr>
										<tr>
											<td class="label" align="right">
											...
											<td align="left">
												<input type="text" name="neftCode" maxlength="11" tabindex="16" value='<%=info.getNEFTRTGSCode()%>'/>
											</td>
											<td width="10px">
											...
											<td align="left">
												<input type="text" name="micrNo" maxlength="12" tabindex="17" value='<%=info.getMICRNo()%>'/>
											</td>
										</tr>
										<tr>
											<td class="label" align="right">
											...
											<td align="left">
												<input type="text" name="contactPerson" maxlength="13" tabindex="18" value='<%=info.getContactPerson()%>'/>
											</td>
											...
											<td align="left">
												<input type="text" name="bMobileNo" maxlength="14" tabindex="19" value='<%=info.getMobileNo()%>'/>
											</td>
										</tr>
										<tr>
