...
function confirmationsave(remarkstype){
  if(document.forms[0].remarkstype.value=='salarynotDrawn'){
	  var response =confirm("For the Remark Type : Salary Not Drawn , Emlouments Would be displayed as Zero for the Month :"+monthyear+" in Form-3 Report");
	if (response) {
	return true; 
	}else{
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">   
 ...
 <%
           if (request.getAttribute("transList") != null) {
            	...
            	empList = (ArrayList) request.getAttribute("transList"); 
                ...
                empinfo = (ArrayList)empList.get(0);
				cntinfo = (ArrayList)empList.get(1);      
