					...
					<table width="100%" border="1" cellspacing="0" cellpadding="0">
						...
						if(request.getAttribute("form8List")!=null){
						   ...
						   for(int j=0;j<form8List.size();j++){
							...
							dataList=(ArrayList)form8Bean.getForm8List();
							remittanceBean=form8Bean.getRemittanceBean();
							//dataList=(ArrayList)form8List.get(0);
							//remittanceBean=(Form8RemittanceBean)form8List.get(1);
							...
							if(pensionList.length<2){
								System.out.println("pensionInfo pensionList.length<2"+pensionInfo);
							}
							if(pensionList.length>=2){
