...
<html>
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>reportservlet?method=loadform7Input";
	...
	function validateForm() {
		...
		if(document.forms[0].select_year.selectedIndex<1 && empserialNO=='')
   		...
   		if(document.forms[0].select_region.selectedIndex<1 && empserialNO==''){
		...
		if(formType=='FORM-7PS'|| formType=='FORM-7PS-SUMMARY'){
		...
		<form action="post">
			...
			<table width="75%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbborder">
				...
				<tr>
					...
					<td width="50%" ><Select name='select_formType' Style='width:100px' align="left">
						<option value='PAYARREARS'>PAY ARREARS</option>
						</SELECT>
					</td>
				</tr>
				<TR>
