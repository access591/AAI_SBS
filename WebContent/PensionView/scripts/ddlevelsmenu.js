...
downarrowpointer: [urlPath+"/PensionView/images/spacer.gif", 3,7], //path to "down arrow" image that gets added to main menu items (last 2 parameters should be width/height of img)
rightarrowpointer: [urlPath+"/PensionView/images/arrow-right.gif", 12,14], //path to "right arrow" image that gets added to LI elements within drop down menu containing additional menus
hideinterval: 500, //delay in milliseconds before entire menu disappears onmouseout.
effects: {enableswipe: true, enablefade: true, duration: 900},
