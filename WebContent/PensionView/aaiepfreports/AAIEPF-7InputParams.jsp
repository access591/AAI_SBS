...
<%String path = request.getContextPath();
            String basePath = request.getScheme() + "://"
                    ...
                    String[] year = {"1995-96","1996-97","1997-98","1998-99","1999-00","2000-01","2001-02","2002-03","2003-04","2004-05","2005-06","2006-07","2007-08","2008-09","2009-10","2010-11","2011-12","2012-13","2013-14"};
                    String[] userYears = {"2008-09","2009-10","2010-11","2011-12","2012-13","2013-14"};		
            %>
<html>
	<HEAD>
 ...
 function LoadWindow(params){
	...
	winHandle = window.open(newParams,"AAIEPF7","menubar=yes,toolbar = yes,scrollbars=yes,resizable=yes");
	winOpened = true;
	winHandle.window.focus();
}  
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>aaiepfreportservlet?method=loadepf6";
	...
	function validateForm() {
		...
		params = "&frm_region="+regionID+"&frm_airportcode="+airportcode+"&frm_year="+yearID+"&frm_reportType="+reportType+"&sortingOrder="+sortingOrder+"&frm_month="+monthID;
	...
	<body class="BodyBackground" onload="javascript:frmload()">
		...
		<form action="post">
			...
			<table width="75%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbborder">
				...
				<tr>
																	<td class="label" align="right">
																		Region:<%if (!session.getAttribute("usertype").equals("Admin")) { %>
																		<font color=red>*</font>
																		<%}%> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																	</td>
																	<td>
						...
						<SELECT NAME="select_reportType" style="width:100px" onChange="javascript:getAirports('data')">
							...
							<option value="ExcelSheet">
								...
								<tr>
																	...
																	<td>
																		<SELECT NAME="select_sorting" style="width:100px">
