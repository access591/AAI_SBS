  ...
  <tr>
    <td colspan="25"><table width="1351" border="1" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td rowspan="2"><div align="center">Region </div></td>
        <td  rowspan="2"><div align="center">Remarks</div></td>
         <td  rowspan="2"><div align="center">Requested By</div></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="Data"><%=AAIEPF1Bean.getOutstandingAmt() %></td>
          <td class="Data"><%=AAIEPF1Bean.getAdjPensioncontri()%></td>
        <td class="Data"><%=AAIEPF1Bean.getRegion()%></td>
        <%if(request.getAttribute("adjtype")!=null && request.getAttribute("adjtype").equals("M")){%>
        <td class="Data"><%=AAIEPF1Bean.getRemarks()%></td>
       
        <%}else{%>
          <td class="Data">&nbsp;</td>
        <%}%>
         <td class="Data"><%=AAIEPF1Bean.getRequestedBy().toUpperCase()%></td>
      </tr>
