...
<table width="1343" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="49">&nbsp;</td>
    <td width="72">&nbsp;</td>
    <td colspan="3" nowrap="nowrap">Form no:  AAIEPF-8(Exclude PC)</td>
    <td width="20">&nbsp;</td>
  </tr>
  ...
  <tr>
   ...
   <tr>
    <td colspan="18"><table cellspacing="0" cellpadding="0">
      <tr>
        <td height="24" colspan="8" width="1300" align="right">MONTHLY SCHEDULE OF REFUNDABLE ADVANCE/NRFW/PFW &amp; FINAL SETTLEMENT(Exclude PC)  MONTH &nbsp;:<%=request.getAttribute("month")%> &nbsp;&nbsp;&nbsp; FY&nbsp;:&nbsp;<%=request.getAttribute("finYear")%></td>
      </tr>
    </table></td> 
  ...
  <tr>
    <td colspan="24"><table width="1333" border="1" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="42" valign="top"><div align="center">Employee Share</div></td>
        <td width="42" valign="top"><div align="center">AAI Share (17=17-18)</div></td>
        <td width="42" valign="top"><div align="center">Pension Contribution deducted</div></td>
        <td width="42" valign="top"><div align="center">Net Payment (16+17)</div></td>
     ...
     <% for(int i=0;i<loanList.size();i++){
      ...
      <tr>
       ...
       <td class="Data" nowrap="nowrap"><%=AAIEPF8Bean.getTransDate()%></td>
        ...
        <td class="Data"><%=AAIEPF8Bean.getEmpShare()%></td>
        <td class="Data"><%=df.format(Double.parseDouble(AAIEPF8Bean.getAAIShare()) -Double.parseDouble(AAIEPF8Bean.getPensionContribution()))%></td>
        <td class="Data">&nbsp;</td>
      ...
      <tr>
       ...
       <td class="Data" nowrap="nowrap">&nbsp;</td>
        ...
        <td class="Data" nowrap="nowrap"><%=df.format(finalSetAAITotal-pensionContTotal)%></td>
         <td class="Data" nowrap="nowrap">&nbsp;</td>
