   ...
   <form name="personalMaster" action="" method="post">
	 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<%if(!message.equals("")){%>
				...
				<tr>
				<td  colspan="5"  height="4%"   class="ScreenMasterHeading">PFID Form[Search] 
				</td>
			</tr>
			<tr><td>&nbsp;</td>	</tr>
					<tr>
		...
		<table  width="70%" border="0" align="center" class="tbborder">			 
			...
			if (request.getAttribute("searchList") != null   ) {
				   ...
				   <tr>							
								...
								<display:table  style="width: 750px" id="advanceList" sort="list"   pagesize="15" name="requestScope.searchList" requestURI="./psearch?method=searchForPfidProcess" >   											
									...
									<display:column property="employeeName"   headerClass="sortable" title="Employee Name" class="datanowrap"/>
								 	<display:column property="employeeNumber"  title="Employee No" />	
