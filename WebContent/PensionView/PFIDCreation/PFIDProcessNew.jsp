...
<html>
  <head>
	...
	function validate(){
		...
		process.style.display="none";
   		 var empName="",airportID="",desegnation="",day="",month="",year="",regionID="",gender="",option="",fhname="",remarks="",pfidStatus="";
...
function valDupRecords(){	
	...
	var pensionNo="";
		...
		if(xmlHttp.readyState ==4){
			if(xmlHttp.status == 200){ 
				...
				//alert("==stype.length=="+stype.length);
				 ...
				 alert("Same Name,DateOfBirth Exists for the PFID "+pensionNo+" .Please Check Once and Proceed");
				 }else{
		...
		url="<%=basePath%>psearch?method=savePFIDProcessInfo&fileName="+fileName+"&region="+regionID+"&airPortCode="+airportID+"&empName="+empName+"&frm_dateOfBirth="+dob+"&doj="+doj+"&cpfaccno="+cpfaccno+"&employeeNo="+employeeNo+"&gender="+gender+"&fhname="+fhname+"&option="+option+"&desegnation="+desegnation+"&remarks="+remarks+"&frmName="+'<%=frmName%>';
		//alert(url);
	 ...
	 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td height="15%">
				...
				<tr class="tbheader">
				<td  colspan="4" align="center" class="tblabel">PFID Process Form[New]</td>
			</tr>
<!--			<tr ><td style="hight:10px" colspan="4">&nbsp;</td></tr>-->
					<tr>
						...
						<td>
							...
							<option value="NO-SELECT">[Select One]</option>
								   ...
								   %>
								     <option value='<%=loginUsrRegion%>' <% out.println("selected");%>><%=loginUsrRegion%></option>								
								   <% }else{
					...
					<tr>
						...
						<td><input type="text" name="empName" onkeyup="return limitlength(this, 20)">
						</td>
						<td class="label">Designation:</td>
						<td><input type="text" name="empDesegnation" onkeyup="return limitlength(this, 20)">
...
<tr><td class="label">
					...
					<tr>
						...
						<td>
								...
								<input type="button" class="btn" value="Reset" onclick="javascript:resetParams()" class="btn">
								<input type="button" class="btn" value="Cancel" onclick="javascript:gotoSearch()" class="btn">
						</td>
