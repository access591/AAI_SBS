  ...
  <head>
   <meta http-equiv="keywords" content="keyword1,keyword2,keyword3"/>
	...
	function resetSearch(){
     				document.forms[0].action="<%=basePath%>psearch?method=loadPFIDProcessSearchForm&frmName=PFIDRecommendationSearch";
	 ...
	 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td height="15%">
				...
				<tr class="tbheader">
				<td  colspan="4" align="center" class="tblabel">PFID Recommendation Form[Search] 
				</td>
			</tr>
			<tr>
			<td>&nbsp;</td>
		...
		<table  width="70%" border="0" align="center" class="tbborder">
				<tr > 
				<td colspan="4" align="center"> 
				<td align="left"><input type="button"  value="Approve" class="btn" onclick="editCheckedRecord();" /> </td>	 
			...
			if (request.getAttribute("searchList") != null   ) {
				   ...
				   <tr>							
								...
								<display:table  style="width: 780px" id="advanceList" sort="list"   pagesize="15" name="requestScope.searchList" requestURI="./psearch?method=searchForPfidProcess" >   											
