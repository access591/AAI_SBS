  ...
  <head>
   <meta http-equiv="keywords" content="keyword1,keyword2,keyword3"/>
	...
	function resetSearch(){
     				document.forms[0].action="<%=basePath%>psearch?method=loadPFIDProcessSearchForm&frmName=PFIDApprovedSearch";
	...
	function returnNew(){ 
		document.forms[0].action="<%=basePath%>psearch?method=loadPFIDProcessNewForm&frmName=PFIDApprovedSearch";
	  	document.forms[0].method="post";
		document.forms[0].submit();
  ...
  <body onload="javascript:frmload()">
   <form name="personalMaster" action="" method="post">
	 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td height="15%">
				<table  width="80%" border="0" cellpadding="1" align="center" cellspacing="0" class="tbborder">
				<tr class="tbheader">
				<td  colspan="4" align="center" class="tblabel">PFID Approved Form[Search] 
				</td>
			</tr>
				<tr>
			<td>&nbsp;</td>
		...
		<tr>
			<td height="15%">
		 <table  width="80%" border="0" align="center" class="tbborder">
				<tr > 
				 <td>&nbsp;</td>
				 <td align="left"><input type="button"  value="Files" class="btn" onclick="getPfidFiles();" /></td>
				 <td>&nbsp;</td>
				 <td>&nbsp;</td>
			</tr>
			 </table> 
			...
			if (request.getAttribute("searchList") != null   ) { 
				   ...
				   <tr>							
								...
								<display:table  style="width: 860px" id="advanceList" sort="list"   pagesize="15" name="requestScope.searchList" requestURI="./psearch?method=searchForPfidProcess" >   											
    								...
    								<display:column property="processID" title="Process ID" class="datanowrap"/> 			 
    								<display:column property="pensionNo" title="Pension No" class="datanowrap"/>
    								<% j++;%>
									...
									<display:column property="approvedBy"  title="ApprovedBy" class="datanowrap"/>
								    </display:table>
								</td>
							</tr> 
						</table>  
