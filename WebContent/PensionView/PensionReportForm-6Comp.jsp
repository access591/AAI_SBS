...
<table width="100%" border="0" align="center" cellpadding="0"
	...
	<%
	 ...
	 if (request.getParameter("frm_reportType") != null) {
		...
		String formDate="",toDate="",loadYear="",formattedFromDate="",formattedToDate="",diplayMessage="",year="";
		...
		year=commonUtil.converDBToAppFormat(formDate,"dd-MMM-yyyy","yyyy");
	...
	%>
			...
			ArrayList form68list=new ArrayList();
			...
			if(Integer.parseInt(year)>=2008){
				...
				System.out.println("Before condition"+dates);
				form68list=finReportService.remittanceform68Report(dates,sortingOrder,region,"",false,true,"Form-6");
				cntpf=((ArrayList)form68list.get(0)).size();
				remittanceBean=(Form8RemittanceBean)form68list.get(1);
			...
			System.out.println("Else Before calling"+year);
