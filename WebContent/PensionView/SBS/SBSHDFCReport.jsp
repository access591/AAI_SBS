...
<script type="text/javascript">
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<tr>
								<td colspan="16" class="ReportHeading"> HDFC Annuity Approved Report</td></tr>
							<tr>
				...
				%>
							<tr>
								...
								<td class="<%=styleClass%>" >pbean.setAppDate() %></td>
								...
								<td class="<%=styleClass%>" ><%=pbean.getEdcpCorpusAmt()%></td>
                                ...
                                <td class="<%=styleClass%>" ><%=pbean.getMobilNo1()%></td>
								...
								<%  ArrayList list= (ArrayList)pbean.getNomineeList();
								  ...
								  <td><%=nomineeBean.getNomineename() %></td>
								  <td><%=nomineeBean.getNomineeDOB() %></td>
								  <td><%=nomineeBean.getGender() %></td><td>
								  <%=nomineeBean.getNomineeRelation() %></td>
								  <td><%=nomineeBean.getPercentage() %></td>
			                      <% }%>
								  <%  
			                      ...
			                      <td><%=appointeeBean.getNomineename()%></td>
								  <td><%=appointeeBean.getAppointeeName()%></td>
								  <td><%=appointeeBean.getNomineeDOB()%></td>
								  <td><%=appointeeBean.getNomineeRelation()%></td>
								  <td><%=appointeeBean.getAppointeeMobile()%></td>
								  <td><%=appointeeBean.getAppointeeAddress()%></td>
			                     <% } %>
							</tr>
						<%}%>
						<%}else{%>
