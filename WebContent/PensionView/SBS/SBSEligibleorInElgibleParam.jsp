...
<head>
	...
	//pfid=document.forms[0].empserialNO.value;
		...
		var url='';
		url="<%=basePath%>sbssearch?method=searchPersonalEligible&region="+regionID+"&airPortCode="+airportID+"&frm_sortingColumn="+sortColumn+"&sbsoption="+sbsoption+"&pfid="+pfid+"&frm_reportType="+reportType;
   ...
   <form name="personalMaster"  method="post">
   	...
   	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="row">
			    <div class="col-md-12">
				<h3 class="page-title">SBS Eligible/InEligible Report Params</h3>
