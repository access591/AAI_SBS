...
<head>
	...
	//pfid=document.forms[0].empserialNO.value;
   		...
   		//alert(regionID);
		var url='';
		url="<%=basePath%>SBSAnnuityServlet?method=MISReport&region="+regionID+"&airPortCode="+airportID+"&frm_reportType="+reportType+"&formType="+formType;
     ...
     function viewPersonalDetails(pfid,obj,employeeName,employeeCode,region,airportCode,index,totalData){
	   ...
	   document.forms[0].action=url;
		...
		function resetMaster(){
     				document.forms[0].action="<%=basePath%>SBSAnnuityServlet?method=MISStatusReportParam&&menu=M4L5";
					document.forms[0].method="post";
					document.forms[0].submit();
   ...
   <form name="personalMaster"  method="post">
   	...
   	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="row">
			    <div class="col-md-12">
				<h3 class="page-title">MIS Status Report Params</h3>
		...
		<div class="row">
			...
			<div class="row">
						...
						<option value="MISEmployeeWise">
								MIS Status Report Employee Wise
							</option>
		...
		<!--  <div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label col-md-4">Employee Name<font color=red>*</font>
								 : </label>
