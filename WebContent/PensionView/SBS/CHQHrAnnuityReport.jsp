...
<%if(bean.getRegion().equals("CHQNAD")){ %>
<tr>
						<td colspan="6">
...
ii) If Yes then whether recovery on notional increment is appearing in Corpus card?
	...
	<tr>
			...
			<tr>
					...
					<tr>
									...
									<td class="reportdata" align="center" colspan="3">
																	
	

			<%if(bean.getFormType().equals("RCForm")){%>
			Approval of Regional Sub-Committee comprising of HoD (F&A) and HoD(HR) of Region <br/>
    The Refund Application form is approved for payment in favour of <%=bean.getMemberName() %> for an amount of  Rs.<%=bean.getRhqHrPurchaseAmt() %>(Interest upto Month_<%=bean.getRhqHrIntDate() %>____).
   <%}else{%>
									
		Approval of Regional Sub-Committee comprising of hoD (F&A) and HoD(HR) of Region .<br/> The Annuity Application form is approved for purchase of Annuity policy purchase amounting to Rs._<%=bean.getRhqHrPurchaseAmt() %>_(Interest upto Month_<%=bean.getRhqHrIntDate() %>____).
<%}%>
								...
								<tr>
									...
									<td width="46%" class="reportsublabel" align="right">
										...
										<%=bean.getRhqHrDisplayname() %><br/><%=bean.getRhqHrDesignation() %>
									</td>
								</tr>
								<tr>
									<td>
								...
								<tr>
									...
									<td width="31%" class="reportsublabel">
										&nbsp;Date : <%=bean.getRhqFinApproveDate() %>
									</td>
									<td width="3%">
										&nbsp;
									</td>
									<td width="46%" class="reportsublabel" align="right">
										...
										<!-- <img src="<%=basePath%>/uploads/dbf/">-->
										<%=bean.getRhqFinDisplayname() %><br/><%=bean.getRhqFinDesignation() %>
								...
								<tr>
									...
									<td width="46%" class="reportsublabel" align="right">
										...
										<%=bean.getChqHrDisp() %><br/><%=bean.getChqhrDesig() %>
