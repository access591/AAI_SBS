...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<tr>
								<td colspan="14" style="font" class="ReportHeading" >SBS Employee Wise Total -  <%=region%> - <%=airport %></td>
							...
							<tr>
								...
								<th class="label" style="width:130px">Gross Contribution-Jan2007 upto Dec2016</th>
								<!--<th class="label" style="width:130px">Gross Contribution-Jan2017 to March 2020</th>
								<th class="label" style="width:130px">Total Gross Contribution-Jan2007 to March 2020</th>-->
								
								
								<th class="label" style="width:200px">Notional Increment Recovery-Jan2007 to Dec2016  </th>
								<!--<th class="label" style="width:200px">Notional Increment Recovery-Jan2017 to March2020  </th>
								<th class="label" style="width:200px">Total Notional Increment Recovery-Jan2007 to March2020 </th>-->
								<th class="label" style="width:180px">Adjusted EDCP Contribution-Jan2007 to Dec2016</th>
								<!--<th class="label" style="width:180px">Adjusted EDCP Contribution-Jan2017 to March 2020</th>
								<th class="label" style="width:180px">Adjusted EDCP Contribution-Jan2007 to March2020</th>-->
				...
				double sbsContri2016Tot=0.0,sbsContri2020Tot=0.0,noIncrementTotal2016=0.0,noIncrementTotal2020=0.0,adjSbsContriTotal2016=0.0,adjSbsContriTotal2020=0.0;
				...
				for(int k=0;k<dataList.size();k++){
					...
					totCount=count;
					sbsContri2016Tot=sbsContri2016Tot+Double.parseDouble(sbsPerBean.getSbscontri2016());
					sbsContri2020Tot=sbsContri2020Tot+Double.parseDouble(sbsPerBean.getSbscontri2020());
					noIncrementTotal2016=noIncrementTotal2016+Double.parseDouble(sbsPerBean.getNoIncrement2016());
					noIncrementTotal2020=noIncrementTotal2020+Double.parseDouble(sbsPerBean.getNoIncrement2020());
				adjSbscontri2016=Double.parseDouble(sbsPerBean.getSbscontri2016())-Double.parseDouble(sbsPerBean.getNoIncrement2016());
				adjSbscontri2020=Double.parseDouble(sbsPerBean.getSbscontri2020())-Double.parseDouble(sbsPerBean.getNoIncrement2020());	
				adjSbsContriTotal2016=adjSbsContriTotal2016+adjSbscontri2016;
				adjSbsContriTotal2020=adjSbsContriTotal2020+adjSbscontri2020;
				...
				%>
							...
							<tr>
								...
								<td ><%=sbsPerBean.getSbscontri2016() %></td>
								<!--<td ><%=sbsPerBean.getSbscontri2020() %></td>
								<td ><%=sbsPerBean.getSbsContri()%></td>-->
								<td ><%=sbsPerBean.getNoIncrement2016()%></td>
								<!--<td ><%=sbsPerBean.getNoIncrement2020() %></td>
								<td ><%=sbsPerBean.getNoIncrement()%></td>-->
								<td ><%=df.format(adjSbscontri2016)%></td>
								<!--<td ><%=df.format(adjSbscontri2020) %></td>
						...
						<tr >
								...
								<td style="font-weight:bold"><%=df.format(sbsContri2016Tot)%></td>
								<!--<td style="font-weight:bold"><%=df.format(sbsContri2020Tot)%></td>
								<td style="font-weight:bold"><%=df.format(sbsContriTotal)%></td>-->
								<td style="font-weight:bold"><%=df.format(noIncrementTotal2016)%></td>
								<!--<td style="font-weight:bold"><%=df.format(noIncrementTotal2020)%></td>
								<td style="font-weight:bold"><%=df.format(noIncrementTotal)%></td>-->
								<td style="font-weight:bold"><%=df.format(adjSbsContriTotal2016)%></td>
								<!--<td style="font-weight:bold"><%=df.format(adjSbsContriTotal2020)%></td>
