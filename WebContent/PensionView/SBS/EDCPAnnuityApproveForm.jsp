...
String corpusamt=request.getAttribute("corpusamt")!=null?request.getAttribute("corpusamt").toString():"";
String corpusintamt=request.getAttribute("corpusintamt")!=null?request.getAttribute("corpusintamt").toString():"";
...
//alert(document.approve.approveStatus.value);
//if(!this.approve.hrVeri.checked){
//alert("Please select the Verified by HR");
//document.approve.hrVeri.focus();
		//return false;
//}
//if(!this.approve.tdsrec.checked){
//alert("Please select the TDS if any");
//document.approve.tdsrec.focus();
	//	return false;
//}
  }else{
...
return false;
  ...
  var url="<%=basePath%>SBSAnnuityServlet?method=edcpApproveUpdate&&ApproveLevel=edcp&&menu=<%=menu%>";
		//alert(url);
...
document.approve.corpusamt.value="<%=corpusamt%>";
document.approve.corpusint.value="<%=corpusintamt%>";
document.approve.intcalcdate.value="<%=intDate%>";
//alert(document.approve.intcalcdate.value);
}
function getUpdate(){
$('#loadcorpus').show();
...
function getReport(appid){
  ...
  function loadcorpusamt(){
   var url="<%=basePath%>SBSAnnuityServlet?method=loadCorpus&&menu=<%=menu%>&&finyear=2021-2022";
		//alert(url);
					document.approve.action=url;
					document.approve.method="post";
					document.approve.submit();
			   ...
			   <div class="row">
                      ...
                      <div class="col-md-6">
                                                    <div class="input-group input-medium date date-picker col-md-12"  data-date-format="dd-M-yyyy" data-date-viewmode="years" data-date-minviewmode="months">
                                                        <input type="text" name="intcalcdate" class="form-control" onchange="getUpdate();" readonly>
                      ...
                      <div class="col-md-6">
                                        ...
                                        <div class="">
												<div class="col-md-12" style="text-align:center">
													...
													<button type="button" id="loadcorpus" style="display:none" class="btn green" onclick="loadcorpusamt()">Load Corpus & Interest Amount</button>
								...
								<%}%>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                <label class="control-label col-md-6">
                                                  Corpus amount as on <span class="required"></span>
                                                    :
                                                </label>
                      <div class="col-md-6">
                                                   <input type="text" class="form-control" name="corpusamt" value="" />
                      ...
                      <div class="col-md-6">
                                                   <input type="text" class="form-control" name="corpusint" value="" />
