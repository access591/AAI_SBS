...
%>
  <form action="method">
	 ...
	 String fullWthrOptionDesc="",genderDescr="",mStatusDec="";
  	 String employeeNm="",pensionNo="",dos="",sreason="",doj="",dob="",cpfacno="",employeeNO="",designation="",fhName="",gender="",fileName="",mStatus="",discipline="",newemployeecode="",docofEDCR="";
    ...
    if(PensionContributionList.size()>0){
 	 for(int i=0;i<PensionContributionList.size();i++){
			...
			doj=contr.getEmpDOJ();
			dos=contr.getDateofSeperationDt();
			sreason=contr.getSeparationReason();
...
%>
               ...
               String headingsub="Opening Corpus -FOR MEMBERS FOR THE YEAR ";
                %>
						...
						<td>
								...
								<tr>
								<td align="center" class="ReportHeading" colspan="2"> <%=headingsub%>  <%=commonUtil.converDBToAppFormat(docofEDCR,"dd-MMM-yyyy","dd.MM.yyyy") %> To 31.12.2016</td>	
								</tr>
								</table>
								</td>
							</tr>
					...
					<td>
						<table class="sample"   cellpadding="2" cellspacing="0" width="100%" align="center" 	>
							...
							<tr>
								...
								<td class="reportdata"><%=dos %></td>
								<td class="reportsublabel">Separation Reason</td>
								<td class="reportdata"><%=sreason%></td>
				...
				<tr>
					<td  colspan="5" >
						...
						<table  class="sample"    cellpadding="2" cellspacing="0" width="100%" align="center" >
							...
							<th class="label" width="10%" align="center">Contribution upto Dec2016 salary</th>
						...
						intrestrate.put("2020-2021","0");
							...
							double totalEmoluments=0.0,pfStaturary=0.0,totalPension=0.0,empVpf=0.0,principle=0.0,interest=0.0,pfContribution=0.0,adjustmentemoluments=0.0,totSbsContr=0.0,totNTIRecovery=0.0,totAdjSbsContri=0.0,totAdjSbsContri2016=0.0,totAdjSbsContri2017=0.0,totGrossContri=0.0,totintrest=0.0,totTaxIncome=0.0,totTaxIncomeSBS=0.0,totcl=0.0,totClIntrest=0.0,totAprList=0.0,grandpercentageintrest=0.0,grandpercentageadj=0.0;
							double obIntrest=0.0;
							String monthProduct="0";
							double grandEmoluments=0.0,grandCPF=0.0,grandPension=0.0,grandPFContribution=0.0,intrestvalue=0.0,sbscont=0.0,NTIRecovery=0.0,taxbleIncome=0.0,taxbleIncomeSBS=0.0,adjSbsContri=0.0,adjSbsContri2016=0.0,adjSbsContri2017=0.0,grossSbsContri=0.0,grandAdjuscontr=0.0,grandAdjuscontr2016=0.0,grandAdjuscontr2017=0.0,grandSbsContr=0.0,grandtotintrest=0.0,grandNoIncrement=0.0;
						...
						if(Double.parseDouble(bean.getEmoluments())!=0.0){
						   ...
						   //  System.out.println("intrest value===================="+Math.round(((Double.parseDouble(bean.getEmoluments())*0.1)*Double.parseDouble((intrestrate.get(finTotalYear)).toString())/100)*(Double.parseDouble(product.get(monthYear.substring(0,3)).toString())/12)));
						     ...
						     // grossSbsContri=adjSbsContri+intrestvalue;
						       ...
						       if(bean.getSbsContriFlag().equals("Y")){
						       adjSbsContri2016=adjSbsContri;
						       adjSbsContri2017=0.0;
						       }else{
						       adjSbsContri2017=adjSbsContri;
						       adjSbsContri2016=0.0;
							...
							//	cumPFStatury=cumPFStatury+pfStaturary;
								...
								totAdjSbsContri2016=new Double(df.format(totAdjSbsContri2016+adjSbsContri2016)).doubleValue();
								totAdjSbsContri2017=new Double(df.format(totAdjSbsContri2017+adjSbsContri2017)).doubleValue();
			  ...
			  <%} %>
								...
								<td class="Data" align="right"><%=df.format(adjSbsContri2016)%></td>
							...
							<td class="HighlightData" align="right"><%=df.format(totAdjSbsContri2016)%></td>
								...
								//service.saveYearWiseSBS(empSerialNo,finTotalYear,totalEmoluments,adjustmentemoluments,totSbsContr,totClIntrest,"");
								  ...
								  //  System.out.println("cumPFStatury"+cumPFStatury+"cumPension"+cumPension);
									...
									grandAdjuscontr2016=grandAdjuscontr2016+totAdjSbsContri2016;
									grandAdjuscontr2017=grandAdjuscontr2017+totAdjSbsContri2017;
							...
							<td class="HighlightData" align="right"></td>
								...
								<td class="HighlightData" align="right"><%=df.format(grandNoIncrement) %></td>
									...
									<td class="HighlightData" align="right"><%=df.format(grandAdjuscontr2016) %></td>
							...
							%>
							<tr><td class="HighlightData" colspan="6"><b>TDS if any recovered to be recovered from Corpus</b> </td><td colspan="1" class="HighlightData" >Pending</td><td></td><td></td><td class="HighlightData"></td><td ></td>
							</tr>
							<tr><td class="HighlightData" colspan="6"><b> Net Corpus Balance</b> </td><td colspan="1" class="HighlightData" >Pending</td><td></td><td></td><td class="HighlightData"></td><td ></td>
							...
							totAdjSbsContri2016=0;totAdjSbsContri2017=0;
