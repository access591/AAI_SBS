...
document.HDFCForm.nomineeDetails.options[document.HDFCForm.nomineeDetails.options.length]=new Option('x',temp);
document.HDFCForm.nomineeDetails.options[document.HDFCForm.nomineeDetails.options.length-1].selected=true;
}
}
function setValues1() {
	var temp;
	for(var i=0;i<detailArray1.length;i++) {
		...
		document.HDFCForm.nomineeDetailsChild.options[document.HDFCForm.nomineeDetailsChild.options.length]=new Option('x',temp);
		document.HDFCForm.nomineeDetailsChild.options[document.HDFCForm.nomineeDetailsChild.options.length-1].selected=true;
	}
}
...
function save()	{  
var per=document.HDFCForm.percentage.value;
if (per.indexOf('%')!=-1)
{

per=per.substr(0,per.length-1);
document.HDFCForm.percentage.value=per;
  //alert("Please remove % symbol in percentage.")
  //document.nomineeForm.percentage.focus();
  //return false;
}
detailArray[detailArray.length]=[document.HDFCForm.nomineeName.value,document.HDFCForm.nomineeAddress.value,document.HDFCForm.nDOB.value,document.HDFCForm.relationShip.value,document.HDFCForm.percentage.value];

}
function save1()	{  

	detailArray1[detailArray1.length]=[document.HDFCForm.nameofNominee.value,document.HDFCForm.appointeeName.value,document.HDFCForm.appointeeDOB.value,document.HDFCForm.appointeeRelation.value,document.HDFCForm.appointeeMobileNo.value,document.HDFCForm.appointeeAdress.value];

}

function clearDetails()	{

document.HDFCForm.nomineeName.value="";
document.HDFCForm.nomineeAddress.value="";
document.HDFCForm.nDOB.value="";
document.HDFCForm.relationShip.value="";
document.HDFCForm.percentage.value="";
}
function clearDetails1()	{
	 
  document.HDFCForm.nameofNominee.value="";
  document.HDFCForm.appointeeName.value="";
  document.HDFCForm.appointeeDOB.value="";
  document.HDFCForm.appointeeRelation.value="";
  document.HDFCForm.appointeeMobileNo.value="";
  document.HDFCForm.appointeeAdress.value="";
...
function validate(){
	if(document.HDFCForm.priAnnuitName.value==""){
		alert("Please enter the  Primary Annuitant's Name");
		document.HDFCForm.priAnnuitName.focus();
		return false;
		}

	if(document.HDFCForm.dob.value==""){
		alert("Please enter the  Date of Birth ");
		document.HDFCForm.dob.focus();
		return false;
		}
	if(document.HDFCForm.gender.value==""){
		alert("Please enter the  Gender of Primary Annuitant");
		document.HDFCForm.gender.focus();
		return false;
		}

	if(document.HDFCForm.memberempno.value==""){
		alert("Please enter the  Employee Number");
		document.HDFCForm.memberempno.focus();
		return false;
		}


	if(document.HDFCForm.annuadd.value==""){
		alert("Please enter the  Address with Pin code");
		document.HDFCForm.annuadd.focus();
		return false;
		}
	if(document.HDFCForm.mno.value==""){
		alert("Please enter the   Mobile Number");
		document.HDFCForm.mno.focus();
		return false;
		}
	
	if(document.HDFCForm.mno1.value==""){
		alert("Please enter the  Alternate Contact Number");
		document.HDFCForm.mno1.focus();
		return false;
		}
	
	if(document.HDFCForm.eid.value==""){
		//alert("Please enter the  E-Mail I'd");
		//document.HDFCForm.eid.focus();
		//return false;
		}
	
	if(document.HDFCForm.panno.value==""){
		alert("Please enter the  PAN Number");
		document.HDFCForm.panno.focus();
		return false;
		}
	
	if(document.HDFCForm.FName.value==""){
		alert("Please enter the   Father's Name ");
		document.HDFCForm.FName.focus();
		return false;
		}

	if(document.HDFCForm.acno.value==""){
		alert("Please enter the  Bank Account Number");
		document.HDFCForm.acno.focus();
		return false;
		}
	
	if(document.HDFCForm.bname.value==""){
		alert("Please enter the Bank Name ");
		document.HDFCForm.bname.focus();
		return false;
		}
	
	if(document.HDFCForm.ifscode.value==""){
		alert("Please enter the  IFSC Code ");
		document.HDFCForm.ifscode.focus();
		return false;
		}

	if(document.HDFCForm.micode.value==""){
		alert("Please enter the  MICR Code ");
		document.HDFCForm.micode.focus();
		return false;
		}
	
	if(document.HDFCForm.acctype.value==""){
		alert("Please enter the Account Type");
		document.HDFCForm.acctype.focus();
		return false;
		}
	
	if(document.HDFCForm.badd.value==""){
		alert("Please enter the Branch Address");
		document.HDFCForm.badd.focus();
		return false;
		}
	
	//if(document.HDFCForm.corpusamt.value==""){
		//alert("Please enter the CorpusAmount");
		//document.HDFCForm.corpusamt.focus();
		//return false;
		//}
	if(document.HDFCForm.apaymentMode.value==""){
		alert("Please select the Frequency payouts");
		document.HDFCForm.apaymentMode.focus();
		return false;
		}
	if(document.HDFCForm.aaiedcpsOption.value==""){
		alert("Please select the Annuity option");
		document.HDFCForm.aaiedcpsOption.focus();
		return false;
		}
		
		if(document.HDFCForm.aaiedcpsOption.value=="C" || document.HDFCForm.aaiedcpsOption.value=="D"){
	if(document.HDFCForm.secannuityname.value==""){
		alert("Please enter the Secondary annuitant");
		document.HDFCForm.secannuityname.focus();
		return false;
		}
	
	if(document.HDFCForm.gendersecann.value==""){
		alert("Please enter the Gender of secondary annuitant");
		document.HDFCForm.gendersecann.focus();
		return false;
		}
	if(document.HDFCForm.secannuitydob.value==""){
		alert("Please enter the  Date of birth of secondary annuitant");
		document.HDFCForm.secannuitydob.focus();
		return false;
		}
	
	if(document.HDFCForm.secannuityrelation.value==""){
		alert("Please enter the  Relationship with Primary Annuitant");
		document.HDFCForm.secannuityrelation.focus();
		return false;
		}


	if(document.HDFCForm.secannuitypan.value==""){
		alert("Please enter the  PAN number of secondary annuitant");
		document.HDFCForm.secannuitypan.focus();
		return false;
		}
	}
	if(document.HDFCForm.nomineeName.value!=""||document.HDFCForm.nomineeAddress.value!=""||document.HDFCForm.nDOB.value!=""||document.HDFCForm.relationShip.value!=""){
	alert("Please Save the Nominee Details");
		document.HDFCForm.nomineeName.focus();
		return false;
	}
	setValues();
	setValues1();
	var url="<%=basePath%>SBSAnnuityServlet?method=addHDFC&&menu=M5L3&&formType=HDFC";
	
				document.HDFCForm.action=url;
				document.HDFCForm.method="post";
				document.HDFCForm.submit();
...
function test(airportCode,serationreason,region,pensionNumber,employeeName,dateofbirth,empSerialNo,dateofseperation,dateofJoining,designation){
			document.HDFCForm.priAnnuitName.value=employeeName;
			document.HDFCForm.memberempno.value=empSerialNo;
		  	document.HDFCForm.dob.value=dateofbirth;
		  	document.HDFCForm.airport.value=airportCode;
		  	document.HDFCForm.region.value=region;
		  	//alert(airportCode);		  		
		}
function getoption(){
  ...
  <form name="HDFCForm"  method="post">
  
   	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="row">
			    <div class="col-md-12">
				<h3 class="page-title">HDFC Form</h3>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-reorder"></i>HDFC Life Proposal Form
                                </div>
                              
                            </div>
                            <div class="portlet-body form">
                            	 <div class="row">
                                    <div class="col-md-12"  style="margin-top:10px;"><h4 class="form-section" style="text-align:left; font-weight:400 !important;"> &nbsp; <i class="fa fa-info-circle" aria-hidden="true" style="font-size:25px;"></i>   Customer consent document for the superannuating employees of Airports Authority of India</h4>
</div></div>
                                <div class="row">
...
<span class="required">*</span>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                <label class="control-label col-md-6">
                                                  Gender of Primary Annuitant <span class="required">*</span>
                                                    :
                                                </label>
                                                <div class="col-md-6">
						...
						<%}else{ %>
                                                    <input name="memberempno" maxlength="40" value="<%=empPerinfo.getPensionNo() %>" class="form-control" type="text">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                <label class="control-label col-md-6">
                                                    Address with Pin code<span class="required">*</span>
                                                    :
                                                </label>
                                                <div class="col-md-6">
                        <textarea name="annuadd"  class="form-control"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                <label class="control-label col-md-6">
                                                   Alternate Contact Number  <span class="required">*</span>
                                                    :
                                                </label>
                                                <div class="col-md-6">
                                                    <input name="mno1" maxlength="40" class="form-control" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-6">
                                                   <input name="micode" maxlength="40" class="form-control" type="text">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-6">
                                                      <select name="acctype" class="form-control"><option value="">Select </option> <option value="Savings Account">Savings Account </option><option value="Current Account">Current Account</option></select> 
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
...
Price (In Rs) <span class="required"></span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                <label class="control-label col-md-6">
                                                 Name of the Annuity Service <span class="required">*</span> :
                                                </label>
                                                <div class="col-md-6">
                                                 <b>HDFC Life Insurance Company Limited. </b>
                                                </div>
                                            </div>
                                        </div>
 					...
 					<div class="col-md-2"> </div>
                                        <div class="col-md-8">
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-3">
                     				Monthly &nbsp; <input name="frequencypayouts" type="radio"   >
                                                </div>
                                                <div class="col-md-3">
                     			Quarterly  &nbsp; <input name="frequencypayouts" type="radio"   >
                                                </div>
                                                <div class="col-md-3">
                     		Half Yearly  &nbsp; <input name="frequencypayouts" type="radio"   >
                                                </div>
                                                <div class="col-md-3">
                     				Yearly  &nbsp; <input name="frequencypayouts" type="radio"   >
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                     				Life Annuity &nbsp; <input name="annuityoption" type="radio"  >
                                                </div>
                                                <div class="col-md-4">
                     			Life Annuity With Return Of Purchase Price &nbsp; <input name="annuityoption" type="radio" >
                                                </div>
                                                <div class="col-md-2">
                     		Joint Life Annuity  &nbsp; <input name="annuityoption" type="radio" value="">
                                                </div>
                                                <div class="col-md-4">
                     				Joint Life Annuity with Return of Purchase Price  &nbsp; <input name="annuityoption" type="radio"   >
                                                </div>
                                            </div>
                                        </div>
...
<div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                <label class="control-label col-md-6">
                                                  Gender of secondary annuitant <span class="required">*</span> :
                                                </label>
                                                <div class="col-md-6">
                                                   <select name="gendersecann" class="form-control"><option value="">Select </option> <option value="Male">Male </option><option value="Female">Female</option></select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group input-medium date date-picker col-md-12"  data-date-format="dd-M-yyyy" data-date-viewmode="years" data-date-minviewmode="months">
                                                        <input type="text" class="form-control" name="secannuitydob" readonly>
                                                        <span class="input-group-btn">
                                                            <button name="dobsecann" class="btn default" type="button" style="padding: 4px 14px;"><i class="fa fa-calendar"></i></button>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                  ...
                                  <div class="row">
                                        ...
                                        <!-- <div class="row" style="padding:20px;">
												<div class="col-md-12" style="text-align:center">
													<button type="button" class="btn green" onclick="return validate();">Submit</button>
