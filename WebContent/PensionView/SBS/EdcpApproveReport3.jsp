...
<tr>
	...
	<tr>
			...
			<tr>
								...
								<tr><td>&nbsp;</td><td colspan="3" class="reportsublabel" align="center"><b><h3> Approval</h3></b></td></tr>
								<tr>
									<td>
										&nbsp;
									</td>
									<td class="reportdata" colspan="3">
								Approved Rs.<%=Double.parseDouble(bean.getEdcpCorpusAmt())+Double.parseDouble(bean.getEdcpCorpusint()) %>/- for <%=Formname%> in favor of <%=bean.getMemberName() %> in accordance as per the <%=Formname%> application form.
								</td>
								</tr>
								<tr>
									<td>
								...
								<tr>
									...
									<td width="46%" class="reportsublabel" align="right">
										...
										Sh.G.S.MOHAPATRA<br/>
										Trustee,AAI EDCP Trust,GM(F&A),CHQ Commitee.
								...
								<tr>
									...
									<td width="46%" class="reportsublabel" align="right">
										...
										Ms.NIVEDITA DUBEY<br/>
										Trustee,AAI EDCP Trust,GM(HR),CHQ Commitee.
