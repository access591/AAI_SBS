...
if(!this.approve.rhqFinVerified.checked){
alert("Please select the Form verification");
document.approve.rhqFinVerified.focus();
		return false;
}
...
return false;
  ...
  var url="<%=basePath%>SBSAnnuityServlet?method=rhqFinApproveUpdate&&ApproveLevel=rhqFin&&menu=<%=menu%>";
		//alert(url);
...
function print(appid,status){
  ...
  return false;
			...
			var url="<%=basePath%>SBSAnnuityServlet?method=annuityReport&&ApproveLevel=RHQHR&&appid="+appid;
...
$('#dispreject').hide();
  ...
  <div class="page-content-wrapper">
		<div class="page-content">
			<div class="row">
			    <div class="col-md-12">
				<h3 class="page-title">RHQ FINANCE Regional Committee</h3>
			 ...
			 <fieldset>
			   <div class="row">
                      ...
                      <div class="col-md-6">
                                                   <input type="text" class="form-control" value='<%=bean.getRhqHrPurchaseAmt() %>'name="purchaseamt"  />
                      ...
                      <div class="col-md-6">
                                                   <div class="input-group input-medium date date-picker col-md-12"  data-date-format="dd-M-yyyy" data-date-viewmode="years" data-date-minviewmode="months">
                                                        <input type="text" name="intcalcdate" value='<%=bean.getRhqHrIntDate() %>'class="form-control"  readonly>
									...
									<div class="col-md-3">
										...
										<div class="col-md-9">
											<div class="form-group ">
												...
												<div class="col-md-9">
												<b> Form Verified </b>
													<input name="rhqFinVerified" type="checkbox" >
