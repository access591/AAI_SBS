...
if(!this.approve.chqHrVerified.checked){
alert("Please select the Form verification");
document.approve.chqHrVerified.focus();
		return false;
}
...
return false;
  ...
  var url="<%=basePath%>SBSAnnuityServlet?method=chqApproveUpdate&&ApproveLevel=chqHr&&menu=<%=menu%>";
		//alert(url);
...
$('#dispreject').hide();
  ...
  <div class="page-content-wrapper">
		<div class="page-content">
			<div class="row">
			    <div class="col-md-12">
				<h3 class="page-title">Social Security Approve Form </h3>
									...
									<div class="col-md-3">
										...
										<div class="col-md-9">
											<div class="form-group ">
												...
												<div class="col-md-9">
												<b> Form Verified </b>
													<input name="chqHrVerified" type="checkbox" >
