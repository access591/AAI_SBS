						...
						<td colspan="6">
							<table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
								...
								<tr>
									...
									<td colspan="3" class="reportsublabel">
										<b>Annuity Form Finance Verification Form:</b>
									</td>
								</tr>
...
d) If yes then OB adjustment for arrear pertaining to pre 01.01.2007 done in the card?
   ...
   <%}else{%>
        Approval of Regional Sub-Committee comprising of hoD (F&A) and HoD(HR) of Region .<br/> 
The Annuity Application form is approved for purchase of Annuity policy purchase amounting to Rs._<%=bean.getRhqHrPurchaseAmt() %>_(Interest upto Month_<%=bean.getRhqHrIntDate() %>____).
