...
<html>
 ...
 var chkpfid="";
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>sbssearch?method=loadSBSCard";
...
function getPFIDNavigationList()
	...
	function validateForm(){
		...
		finyear=document.forms[0].finyear.options[document.forms[0].finyear.selectedIndex].text;
	...
	//	var	page="PensionContribution";
		...
		var params = "&formType="+formType+"&frm_region="+regionID+"&frm_airportcode="+airportcode+"&finyear="+finyear+"&frm_month="+monthID+"&frm_reportType="+reportType+"&frm_formType"+formType+"&empserialNO="+empserialNO+"&frm_pfids="+pfidStrip+"&frm_toyear="+toYearID+"&mappingFlag="+mappingFlag+"&frm_bulkprint="+bulkPrintFlag;
		var url ="",params1="";
	...
	//	}		 
		...
		url="<%=basePath%>sbscard?method=SBSCard"+params;
	//	}
	 // alert(url);
...
--></script>
	...
	<body class="BodyBackground"
		onload="javascript:frmload(),yearSelect();">
		<%
							...
							<div class="col-md-10">
								<div class="form-group">
									...
									<div class="col-md-4">
										...
										<SELECT NAME="select_airport" id="select_airport"
											class="form-control">
							...
							<div class="col-md-10">
								<div class="form-group">
									...
									<div class="col-md-4">
										...
										<input type="text" name="frmpagesize" class="form-control"
											tabindex="3" value="100">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-10">
								<div class="form-group">
									...
									<div class="col-md-1">
										...
										<input type="hidden" name="chk_frmblkprint" id=""
											value="false" />
						...
						<div class="row">
							<div class="col-md-10">
								<div class="form-group">
									...
									<div class="col-md-4">
										<SELECT NAME="select_pfidlst" id="select_pfidlst"
											class="form-control">
