      ...
      <tr>
		...
		if(pensionCardInfo.getTransArrearFlag().equals("Y")){
    		...
    		arrearContriAmount=Double.parseDouble(pensionCardInfo.getOringalArrearContri());
     		arrearflags=true;
    		finalRemarks=pensionCardInfo.getOringalArrearAmnt()+","+pensionCardInfo.getOringalArrearContri();
    	}
		grandEmoluments=grandEmoluments+(Double.parseDouble(pensionCardInfo.getEmoluments())-arrearEmoluemntsAmount);
		grandPension=grandPension+(Double.parseDouble(pensionCardInfo.getPensionContribution())-arrearContriAmount);
...
<tr>
	...
	<td align="center" class="Data"><%=Double.parseDouble(pensionCardInfo.getEmoluments())-arrearEmoluemntsAmount%></td>
	<td align="center" class="Data"><%=Math.round(Double.parseDouble(pensionCardInfo.getPensionContribution())-arrearContriAmount)%></td>
