	...
	<body>
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<td colspan="2">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="20%" nowrap align="left" class="reportlabel">
						...
						<tr>
							...
							<td class="reportlabel" align="left">
								Employee Fresh Pension Option Report
							</td>
			...
			<tr>
				...
				%>
				<td width="15%" class="reportlabel" align="center">
					<b> <%=region%> </b>
				</td>
			...
			%>
				...
				<%}%>
				<td width="85%" colspan="5" class="Data" align="right">
					Date:
					<%=common.getCurrentDate("dd-MMM-yyyy HH:mm:ss")%>
				</td>
				<td width="3%"></td>
			</tr>
