	...
	<body class="BodyBackground" onload="document.forms[0].setEmpSerialNo.focus();hide();swap();retrimentDate();">
		...
		<form method="post" action="<%=basePath%>psearch?method=personalUpdate">
            ...
            %>
                ...
                %>
							...
							-->
										...
										<tr>
											...
											<td>
												<input type="text" name="cpfacnoNew" readonly="true" maxlength="25" tabindex="2" onBlur="charsCapsNumOnly();getPensionNumber();" value='<%=bean1.getCpfAcNo()%>'/>
											</td>
											...
											<td>
												...
												<select name="airPortCode" tabindex="3">
													<option value="">
														[Select One]
													</option>
													<%if (request.getAttribute("AirportList") != null) {
                        ...
                        %>
							...
							-->
										...
										<tr>
											...
											<td>
												<input type="text" name="employeeCode" maxlength="20" tabindex="4" value='<%=bean1.getEmpNumber()%>' onkeyup="return limitlength(this, 20)">
											</td>
											...
											<td>
												<input type="text" name="empName" maxlength="50"  readonly="true" tabindex="5" onblur="getPensionNumber();" value='<%=bean1.getEmpName()%>' onkeyup="return limitlength(this,50)">
											</td>
										</tr>
										<tr>
											<td class="label">
											...
											<td>
												<select name="select_fhname" tabindex="6" style="width:64px">
												...
												<input type="text" name="fhname" maxlength="50" tabindex="7" value='<%=bean1.getFhName()%>' onkeyup="return limitlength(this, 50)">
											</td>
										...
										<tr>
											...
											<td>
												<input type="text" name="dateofbirth" readonly="true" tabindex="9" onblur="retrimentDate();getPensionNumber();" value='<%=bean1.getDateofBirth()%>' onkeyup="return limitlength(this, 20)">
										...
										<tr>
											...
											<td>
												...
												<select name="emplevel" tabindex="11" onchange="getDesegnation(document.forms[0].emplevel.value)">
													<option value="">
														[Select One]
													</option>
											...
											<td>
												<input type="text" name="desegnation" readonly="true" tabindex="12" value='<%=bean1.getDesegnation()%>' onkeyup="return limitlength(this, 20)">
                ...
                %>
												<select name="department" tabindex="13" style=display:inline;>
													<option value="">
														[Select One]
													</option>
                ...
                %>
												<select name="division" tabindex="14">
													<option value="">
														[Select One]
													</option>
                ...
                %><!--						<tr>
                    ...
                    %>
							...
							REMOVED</option>       
											...
											<td>
												<input type="text" name="seperationDate" tabindex="16" value='<%=bean1.getDateofSeperationDate()%>' onkeyup="return limitlength(this, 20)">
										...
										<tr>
											...
											<td>
                                         <input type="text" name="wetherOption" value='<%=bean1.getWetherOption().trim()%>' tabindex="20" readonly="true" >
										...
										<tr>
                                         ...
                                         <td class="label">
											...
											<td>
 											<%String optionform = bean1.getOptionForm().trim(); %>  
												<select name="optionform" tabindex="26">
												         
													<option value="">
														[Select One]
													</option>
													<option value="Y" <%if(optionform.equals("Y")){ out.println("selected");}%>>
														Yes
													</option>
													<option value="N" <%if(optionform.equals("N")){ out.println("selected");}%>>
														No
													</option>
                                                 <option value="NM" <%if(optionform.equals("NM")){ out.println("selected");}%>>
														NM
													</option>
												</select>
											</td>
									...
									<table align="center">
										<tr>
											<td align="center">
												...
												<input type="button" class="btn" value="Update" class="btn" tabindex="46">
