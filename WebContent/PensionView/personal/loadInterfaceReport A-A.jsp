...
<%@ page import="aims.dao.PersonalDAO" %>
<%
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td >&nbsp;</td>
				<td >&nbsp;</td>
				<td  class="reportlabel" align="left" > Fresh Pension Option changed from A - A</td>
		...
		<tr>
			...
			String	reportType=(String)request.getAttribute("reportType");
				...
				if (reportType.equals("Excel Sheet")
					...
					String fileName = "FreshPensionOptionReportA-A.xls";
...
<tr>
	...
	<table width="100%" align="center" cellpadding=2 
			...
			if(request.getAttribute("dataList")!=null) {
				...
				%>
				<tr>
				<td class="label" colspan="12" align="center">
			...
			int j=1;
				for(int i=0;i<dataList.size();i++) {
					EmployeeFreshOptionBean personal =(EmployeeFreshOptionBean) dataList.get(i);
