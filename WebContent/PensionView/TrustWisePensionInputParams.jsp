...
<%String path = request.getContextPath();
            String basePath = request.getScheme() + "://"
                    ...
                    String[] userYears = {"2008","2009","2010"};		
            %>
<html>
	<HEAD>
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>reportservlet?method=loadtrustpcInput";
	...
	function validateForm() {
		...
		url="<%=basePath%>reportservlet?method=trustreport"+params;
			...
			<table width="75%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbborder">
				<tr>
					<td height="5%" colspan="2" align="center" class="ScreenMasterHeading">
						 Trust Wise Pension Contribution Report Params
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td  width="50%" class="label" align="right">Region: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td width="50%" ><SELECT NAME="select_region" style="width:120px" onChange="javascript:getAirports('airport');">
				...
				<tr>
					...
					<td width="50%" ><SELECT NAME="select_airport" style="width:120px">
				...
				<tr>
					<td  width="50%" class=label align="right" nowrap>Division:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
					<td width="50%" ><Select name='select_trustType' Style='width:130px' align="left">
				...
				<tr>
					...
					<td width="50%" ><Select name='select_formType' Style='width:130px' align="left">
				...
				<tr>
					<td  width="50%" class=label align="right" nowrap>Sorting Order: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td width="50%" ><SELECT NAME="select_sorting" style="width:88px">
