<%String path = request.getContextPath();
			String basePath = request.getScheme() + "://"
					...
					String forms[] = {"FORM-4","FORM-5","FORM-6","FORM-6A","FORM-6B","FORM-7","FORM-8","FORM-6-ALL","FORM-7-PS","FORM-8-PS"};
...
function popupWindow(mylink, windowname)
 ...
 function LoadWindow(params){
	...
	function validateForm(user) {
        ...
        if(user!='SEHGAL' && user!='navayuga'&&user!='BALWANT'&&user!='SWATI'&& user!='SHIKHA' && user!='NAGARAJ' && user!='SHANKAR'){
		 ...
		 //  alert("params "+params);
			...
			url = "<%=basePath%>reportservlet?method=form3pfid&frm_region="+regionID+"&frm_year="+yearID+"&frm_month="+monthID+"&frm_reportType="+reportType+"&frm_formType="+formtype+"&frm_airportcd="+airportcode;
