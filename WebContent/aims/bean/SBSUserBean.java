...
import aims.bean.RequestBean;
import aims.common.StringUtility;

public class SBSUserBean extends RequestBean implements Serializable {
	...
	public void setEsignatory(File esignatory) {
		this.esignatory = esignatory;
	}
	public SBSUserBean(HttpServletRequest request){
		super(request);
		}
	public SBSUserBean(String userId,String employeeId,String userType,String profileType,
	...
	public boolean equals(Object obj){
		boolean bool = false;
		if (obj instanceof Bean && ((SBSUserBean)obj).getUserId().equals(this.userId) ) {
			return true;
		}
		return bool;
	}
