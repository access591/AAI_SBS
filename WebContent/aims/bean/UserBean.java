...
public class UserBean {
	...
	String designation = "", dob = "", pensionno = "", email = "",
			primarymodule = "", secondarymodule = "";

	String usertype = "", expirydate = "", division = "", gridlength = "",
			oldpwd = "", newpwd = "", airport = "", groupname = "",
			remarks = "", groupselect = "";

	int userid = 0, groupid = 0, regionId = 0;

	String aaiCategory = "", region = "", loginTime = "", computerName = "",
			loginFromDate = "", loginToDate = "", phoneNo = "",
			passwordFlag = "";

	String passwordChangeFlag = "", stationName = "", userAccType = "",
			userPrevilieges = "", userProfile = "", dbFlag = "",
			sysuserprofile = "";
	...
	public String getUserPrevilieges() {
		return userPrevilieges;
	}

	public void setUserPrevilieges(String userPrevilieges) {
		this.userPrevilieges = userPrevilieges;
	}
