...
String originalEmv="",originalpensionContri="",pensioncontrib="",freshopflag="",emoluments_b="",aaiedcpContri="",notationaIncrement="",deputation="";
...
public String getNotationaIncrement() {
	return notationaIncrement;
}
public void setNotationaIncrement(String notationaIncrement) {
	this.notationaIncrement = notationaIncrement;
}
public String getAaiedcpContri() {
	return aaiedcpContri;
}
public void setAaiedcpContri(String aaiedcpContri) {
	this.aaiedcpContri = aaiedcpContri;
}
